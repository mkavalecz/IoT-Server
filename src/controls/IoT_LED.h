...
class IoT_LED : public IoT_Control {
  ...
  public:
    IoT_LED(const String id, const String name, const int pin)
        : IoT_LED(id, name, pin, false, 255) {
    }

    IoT_LED(const String id, const String name, const int pin, const bool inverted)
        : IoT_LED(id, name, pin, inverted, 255) {
    }

    IoT_LED(const String id, const String name, const int pin, const bool inverted, const int maxBrightness)
