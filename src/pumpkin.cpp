...
IoT_Server server("admin", "admin", "IoT LED Pumpkin",
    {new IoT_Slider(IOT_CONTROL_LED, "Control LED", D4, true, 1023), new IoT_Slider("red", "Red LED", D8),
        ...
        (new IoT_Slider("delayCounter", "Delay Counter", counterMax, 1000, 10000, true))
